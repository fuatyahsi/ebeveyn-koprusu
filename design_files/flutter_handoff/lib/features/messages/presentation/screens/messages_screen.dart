            ...
            Container(
              ...
              child: Text(
                ...
                style: AppTypography.ui(
                    size: 13.5, color: fg, weight: FontWeight.w400, height: 1.45),
              ),
            ),
            Padding(
              ...
              child: Text(
                meta,
                style: AppTypography.mono(color: AppColors.inkMute, letter: 0.4),
              ),
            ),
          ],
        ),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text('Sakin Dil Asistanı',
                          style:
                              AppTypography.display(size: 18, height: 1)),
                      const SizedBox(height: 2),
                      Text('Gönderim öncesi · Premium',
                          style: AppTypography.ui(
                              size: 10.5, color: AppColors.inkSoft)),
                    ],
                  ),
                ),
                    ...
                    Padding(
                      ...
                      child: Text('ÖNERİ',
                          style: AppTypography.mono(
                              letter: 1.6, color: AppColors.sage)),
                    ),
                    const Expanded(child: Divider()),
                  ],
                ),
            ...
            children: [
              Expanded(
                child: Text(
                  'Sakin bir mesaj yaz…',
                  style: AppTypography.ui(
                      size: 13, color: AppColors.inkMute, weight: FontWeight.w400),
                ),
              ),
              Container(
                width: 32,
