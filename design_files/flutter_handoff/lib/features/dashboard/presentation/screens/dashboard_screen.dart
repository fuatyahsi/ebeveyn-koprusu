              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Atatürk İlkokulu · 3-B',
                        style:
                            AppTypography.ui(size: 12, color: AppColors.inkMute)),
                  ],
                ),
              ),
    ...
    return Row(
      children: [
        for (var i = 0; i < _days.length; i++) ...[
          Expanded(child: _DayCell(day: _days[i].$1, who: _days[i].$2, tone: _days[i].$3)),
        ...
        children: [
          Text(day,
              style: AppTypography.ui(
                  size: 9.5, color: fg, weight: FontWeight.w500, letter: 0.6)),
          const SizedBox(height: 2),
          Text(who,
              style:
                  AppTypography.ui(size: 13, color: fg, weight: FontWeight.w600)),
        ],
      ),
    );
  }
                    ...
                    children: [
                      ...
                      Text('Cuma · 17:00',
                          style: AppTypography.display(
                              size: 26, color: AppColors.paper, height: 1)),
                      const SizedBox(height: 6),
                      Text('Okul çıkışı · Anne → Baba',
                          style: AppTypography.ui(
                            size: 12.5,
...
class _QuickActions extends StatelessWidget {
  ...
  static const _actions = <(_QA,)>[
    (_QA('Hızlı teslim', Icons.handshake_outlined, AppColors.sage, AppColors.sageSoft),),
    (_QA('Acil bildirim', Icons.priority_high, AppColors.terra, Color(0x1FB65F46)),),
    (_QA('Masraf ekle', Icons.receipt_long_outlined, AppColors.ochre, AppColors.ochreSoft),),
    (_QA('Rapor üret', Icons.picture_as_pdf_outlined, AppColors.ink, AppColors.paperWhite),),
  ];
...
class _PendingList extends StatelessWidget {
  ...
  static const _items = <(String, String, PillTone, String)>[
    ('Servis ücreti — 1.600 ₺', 'Onayını bekliyor · 2 gün kaldı', PillTone.ochre, 'Bekliyor'),
    ('Doktor randevusu onayı', 'Karar talebi · Baba gönderdi', PillTone.sage, 'Karar'),
