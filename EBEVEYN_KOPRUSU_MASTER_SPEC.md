# EBEVEYN KÖPRÜSÜ — MASTER PROJECT SPECIFICATION
...
İlk sürümde mobil içinde basit admin gerekmez; ancak web tabanlı admin panel ileride hazırlanabilir. Yine de veritabanı admin ihtiyaçlarını desteklemelidir.
...
- Abonelik durumu
- Şikayet kayıtları
- Abuse/risk flag listesi
- Sistem logları
- Rapor doğrulama kayıtları
- Destek talepleri
- Storage kullanımı
- Hata kayıtları

Admin kullanıcılar kesinlikle aile içeriğine sınırsız erişmemelidir. Teknik destek için maskeleme ve sınırlı erişim kullanılmalıdır.
