      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: const [
              Expanded(
                child: _DateBox(label: 'BAŞLANGIÇ', value: '14 Nisan'),
              ),
              SizedBox(width: 10),
              Expanded(
                child: _DateBox(label: 'BİTİŞ', value: '14 Mayıs'),
              ),
            ],
          ),
        ],
          ...
          Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Koordinasyon raporu',
                          style: AppTypography.display(size: 20, height: 1.1),
                        ),
                        const SizedBox(height: 2),
                        Text(
              ...
              Row(
                children: const [
                  Expanded(
                    child: _Stat(value: '12', label: 'TESLİM'),
                  ),
                  Expanded(
                    child: _Stat(value: '4', label: 'KONU'),
                  ),
                  Expanded(
                    child: _Stat(value: '7', label: 'MASRAF'),
                  ),
                ],
              ),
              const SizedBox(height: 12),
    ...
    return Container(
      ...
      child: GridView.count(
        ...
        children: List.generate(49, (i) {
          ...
          return Container(
            color: filled ? AppColors.paper : Colors.transparent,
          );
        }),
      ),
    );
